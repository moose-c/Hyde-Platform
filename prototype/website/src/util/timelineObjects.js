  ...
  },
  {
    ...
    periodText: (component) => (
      <div className="periodText">
        ...
        <p>
          The Early Modern Era laid the foundation for the modern world, marking
          a dynamic interplay between human societies and the environments they
          inhabited. This period of transition set the stage for further
          developments that would continue to shape the destiny of civilizations
